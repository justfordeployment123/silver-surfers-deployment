...
// Ported verbatim from frontend/src/components/WcagStandardSelect.js — a
// custom listbox dropdown (2.2.7.1), used by Home's quick-scan form and
// (in later phases) Checkout/MonitoringJobModal. Interactive (open/close
// state, outside-click + Escape handling), so this stays a Client Component.
...
.wss-trigger--themed.open { border-color: var(--t4); box-shadow: 0 0 0 3px rgba(1,150,189,0.15); }
...
.wss-trigger--glass-dark.open { border-color: var(--t4); box-shadow: 0 0 0 3px rgba(1,150,189,0.15); }
...
.wss-chip--glass-dark { background: rgba(1,150,189,0.22); color: #eafff5; }
`;
