// Ported from frontend/src/components/Footer.js. No hooks, no interactivity
// beyond plain navigation links — safe as a Server Component.
      ...
      <footer className="ss-footer">
        <div className="ss-footer-inner">
          ...
          <div className="ss-footer-grid">
            ...
            {/* Brand column */}
            <div>
              <Link href="/" className="ss-footer-brand-name">
              ...
              <div className="ss-footer-socials">
                ...
                <a
                  ...
                  aria-label="Follow SilverSurfers on LinkedIn"
                >
                ...
                <a
                  ...
                  aria-label="Follow SilverSurfers on Instagram"
                >
                  <svg viewBox="0 0 24 24">
                ...
                <a
                  ...
                  aria-label="Follow SilverSurfers on Facebook"
                >
                  <svg viewBox="0 0 24 24">
                ...
                <a
                  ...
                  aria-label="Follow SilverSurfers on TikTok"
                >
                  <svg viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="ss-footer-links">
                <li><Link href="/services#starter" className="ss-footer-link">Starter</Link></li>
                <li><Link href="/services#pro"     className="ss-footer-link">Pro</Link></li>
                <li><Link href="/contact"        className="ss-footer-link">Custom</Link></li>
                <li>
                  <a
            ...
            <div>
              ...
              <ul className="ss-footer-links">
                ...
                <li><Link href="/faq"     className="ss-footer-link">FAQ</Link></li>
              </ul>
            </div>
