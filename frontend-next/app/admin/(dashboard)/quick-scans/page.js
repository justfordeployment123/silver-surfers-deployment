...
// Ported from frontend/src/pages/admin/AdminQuickScans.js — the "good"
// pagination reference implementation the migration plan calls out
// (real page/limit params, backend-computed total/pages).
import { useState, useEffect } from 'react';
import { adminListQuickScans } from '../../../../lib/apiClient';
