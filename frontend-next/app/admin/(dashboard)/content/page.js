...
.cm-btn-rerun { padding: 6px 12px; border-radius: 8px; background: rgba(1,150,189,0.5); color: #fff; font-size: 16px; font-weight: 700; border: none; cursor: pointer; }
.cm-btn-rerun:hover { background: var(--t4); }
.cm-btn-refresh { padding: 8px 16px; border-radius: 8px; background: rgba(1,150,189,0.5); color: #fff; font-size: 16px; font-weight: 700; border: none; cursor: pointer; }
...
.cm-pill-pub { background: rgba(1,150,189,0.35); border-color: rgba(1,150,189,0.45); color: var(--t3); }
...
.cm-status-completed { background: rgba(1,150,189,0.45); }
...
.cm-card:hover { border-color: rgba(1,150,189,0.35); }
...
.cm-queue-row:hover { border-color: rgba(1,150,189,0.4); }
...
.cm-contact-row:hover { border-color: rgba(1,150,189,0.4); }
.cm-btn-mark-read { padding: 6px 12px; border-radius: 8px; background: rgba(1,150,189,0.5); color: #fff; font-size: 16px; font-weight: 700; border: none; cursor: pointer; }
