...
// Ported from frontend/src/pages/admin/AdminDashboard.js.
import { useState, useEffect } from 'react';
import { useRouter } from 'next/navigation';
import { adminListBlog, adminListFaqs, adminListAnalysis, adminListContact } from '../../../../lib/apiClient';
import { IconPencil, IconQuestion, IconSearch, IconMail, IconUsers, IconClipboard, IconDocument } from '../../../../components/admin/AdminIcons';
        ...
        <div className="ap-card" style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '12px' }}>
            {[
              ...
              <button key={href} onClick={() => router.push(href)} className="ap-quick-btn">
