...
// Ported from frontend/src/pages/QuickScanDetail.js. Dynamic route param via
// next/navigation's useParams() (see the analysis/[taskId]/page.js comment
// for why not props.params).
import { useEffect, useState } from "react";
import { useRouter, useParams } from "next/navigation";
import ProtectedRoute from "../../../../../components/ProtectedRoute";

import { deleteMyQuickScan, fetchMyQuickScanReportFile, getMyQuickScanDetail, rescanMyQuickScan, rerunMyQuickScan } from "../../../../../lib/apiClient";
...
function QuickScanDetailContent() {
            ...
            <div className="qsd-pg">
                <div className="qsd-wrap">
                    <div style={{ marginBottom: '32px', display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                        <div>
                            <button onClick={() => router.push("/account")} className="qsd-back">Back to account</button>
...
export default function QuickScanDetailPage() {
    return (
        <ProtectedRoute>
            <QuickScanDetailContent />
        </ProtectedRoute>
    );
}
