// Ported from frontend/src/pages/Contact.js. Server Component shell (hero,
...
export const metadata = {
  ...
  description: 'Have questions or need a custom quote? Our friendly, expert team is here to help.',
};
          ...
          <div className="wrap">
            <div className="contact-form-wrap">
              <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                ...
                <p className="sub">Tell us about your business and what you hope to achieve. We&rsquo;ll respond promptly.</p>
              </div>
          ...
          <div className="wrap">
            ...
            <div className="g3">
              ...
              <div className="card">
                ...
                <a href={`tel:${CONTACT_INFO.phone}`} className="contact-info-val">
              ...
              <div className="card">
                ...
                <span style={{ fontSize: '16px', color: 'var(--ink)', fontWeight: 500 }}>{CONTACT_INFO.address}</span>
              </div>
              ...
              <div className="card">
                ...
                <p style={{ fontSize: '16px', color: 'var(--ink6)', marginBottom: '8px' }}>When we&rsquo;re available</p>
                <span style={{ fontSize: '16px', color: 'var(--ink)', fontWeight: 500 }}>{CONTACT_INFO.officeHours}</span>
              </div>
              ...
              <div className="card">
                ...
                <p style={{ fontSize: '16px', color: 'var(--ink6)', marginBottom: '8px' }}>How quickly we&rsquo;ll get back to you</p>
                <span style={{ fontSize: '16px', color: 'var(--ink)', fontWeight: 500 }}>{CONTACT_INFO.responseTime}</span>
              </div>
