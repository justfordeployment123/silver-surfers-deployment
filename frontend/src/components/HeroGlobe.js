...
// palettes here, kept in sync by hand with index.css's --t* tokens.
const PALETTES = {
  dark: {
    sphereColor: '#042E22',
    sphereEmissive: '#085041',
    emissiveIntensity: 0.18,
    atmosphere: '#1D9E75',
    tipBg: '#042E22',
    capHover: '#2DB884',
    capHoverNoStat: 'rgba(122,191,170,0.55)',
    capDefault: 'rgba(29,158,117,0.82)',
    capDefaultNoStat: 'rgba(122,191,170,0.16)',
    sideColor: 'rgba(4,46,34,0.35)',
    strokeHover: 'rgba(255,255,255,0.55)',
    strokeDefault: 'rgba(225,245,238,0.28)',
    graticuleColor: 'lightgrey',
    graticuleOpacity: 0.1,
  },
  light: {
    sphereColor: '#BFE3D3',
    sphereEmissive: '#7ABFAA',
    emissiveIntensity: 0.1,
    atmosphere: '#0F6E56',
    tipBg: '#085041',
    capHover: '#0F6E56',
    capHoverNoStat: 'rgba(8,80,65,0.35)',
    capDefault: 'rgba(15,110,86,0.85)',
    capDefaultNoStat: 'rgba(8,80,65,0.14)',
    sideColor: 'rgba(8,80,65,0.25)',
    strokeHover: 'rgba(4,46,34,0.6)',
    strokeDefault: 'rgba(4,46,34,0.3)',
    graticuleColor: '#085041',
