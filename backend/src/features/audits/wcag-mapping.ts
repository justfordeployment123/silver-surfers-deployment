...
export const CRITERION_AUDIT_MAP: Record<string, string[]> = {
    ...
    "2.1.2": ["focus-traps", "axe-focus-trap", "ss-no-keyboard-trap-audit"],
    ...
    "2.5.1": [],
    "2.5.2": [],
    "2.5.3": ["button-name", "axe-label-content-name-mismatch", "ss-label-in-name-audit"],
    "2.5.4": [],
    "2.5.7": [],
...
const STATIC_AUDIT_MAPPINGS: Record<string, string[]> = {
    ...
    "ss-orientation-audit": ["1.3.4"],
    "ss-input-purpose-audit": ["1.3.5"],
    "ss-use-of-color-audit": ["1.4.1"],
    "ss-non-text-contrast-audit": ["1.4.11"],
    "ss-hover-focus-audit": ["1.4.13"],
    "ss-keyboard-audit": ["2.1.1"],
    "ss-no-keyboard-trap-audit": ["2.1.2"],
    "ss-timing-adjustable-audit": ["2.2.1"],
    "ss-pause-stop-hide-audit": ["2.2.2"],
    "ss-focus-order-audit": ["2.4.3"],
    "ss-focus-visible-audit": ["2.4.7"],
    "ss-focus-not-obscured-audit": ["2.4.11"],
    "ss-label-in-name-audit": ["2.5.3"],
    "ss-on-focus-audit": ["3.2.1"],
    "ss-on-input-audit": ["3.2.2"],
    "ss-consistent-navigation-audit": ["3.2.3"],
    "ss-consistent-help-audit": ["3.2.6"],
    "ss-error-identification-audit": ["3.3.1"],
    "ss-status-messages-audit": ["4.1.3"],
};
