...
const analysisRecordSchema = new mongoose.Schema({
  ...
  scannerTier: { type: String, enum: ['aws', 'vps'], default: 'aws' },
  primaryScannerJobId: { type: String, default: null },
  fallbackScannerJobId: { type: String, default: null },
  scannerFallbackCount: { type: Number, default: 0 },
  scannerAttemptHistory: { type: [mongoose.Schema.Types.Mixed], default: [] },
