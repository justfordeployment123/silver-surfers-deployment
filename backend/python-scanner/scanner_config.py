...
FULL_AUDIT_REFS = [
    ...
    {"id": "mixed-content-audit", "weight": 2},
    {"id": "form-action-security-audit", "weight": 2},
    {"id": "third-party-surface-audit", "weight": 1},
    {"id": "trust-markers-audit", "weight": 1},
    {"id": "image-alt", "weight": 5},
    {"id": "focus-traps", "weight": 4},
    {"id": "bypass", "weight": 3},
    {"id": "line-spacing-audit", "weight": 5},
    {"id": "autoplay-audit", "weight": 3},
    {"id": "ss-orientation-audit", "weight": 3},
    {"id": "ss-input-purpose-audit", "weight": 4},
    {"id": "ss-use-of-color-audit", "weight": 4},
    {"id": "ss-non-text-contrast-audit", "weight": 4},
    {"id": "ss-hover-focus-audit", "weight": 3},
    {"id": "ss-keyboard-audit", "weight": 5},
    {"id": "ss-no-keyboard-trap-audit", "weight": 3},
    {"id": "ss-timing-adjustable-audit", "weight": 2},
    {"id": "ss-pause-stop-hide-audit", "weight": 3},
    {"id": "ss-focus-order-audit", "weight": 3},
    {"id": "ss-focus-visible-audit", "weight": 4},
    {"id": "ss-focus-not-obscured-audit", "weight": 2},
    {"id": "ss-label-in-name-audit", "weight": 3},
    {"id": "ss-on-focus-audit", "weight": 2},
    {"id": "ss-on-input-audit", "weight": 2},
    {"id": "ss-consistent-navigation-audit", "weight": 2},
    {"id": "ss-consistent-help-audit", "weight": 2},
    {"id": "ss-error-identification-audit", "weight": 4},
    {"id": "ss-status-messages-audit", "weight": 3},
]
